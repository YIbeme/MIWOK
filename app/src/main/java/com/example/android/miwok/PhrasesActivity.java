...
public class PhrasesActivity extends AppCompatActivity {
    ...
    /*
    Handles playback of all media sound files
     */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //when we override any activity class methods e.g onCreate, onPause,onStop we call the super
        //class of that method
        @Override
        protected void onStop() {
            super.onStop();
            //when the activity is stop released the media player because we dont want to play any
            //more sounds
            releaseMediaPlayer();
        }
