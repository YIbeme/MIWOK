...
public class NumbersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                //mAudioFocusChangeListener is the change listener i defined above as a private
                //variable so with can pass it in as an input param
     ...
     * helper method called releaseMediaPlayer for cleaning up resources of the media player
     * and stopping it
     */
